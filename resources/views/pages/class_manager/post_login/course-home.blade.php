                        ...
                        <div class="table-responsive full-data">
                            <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($courses as $course)  {{-- database eke variable eke data table ekata gannawa --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <img src="{{ asset('images/trans/1.jpg') }}" alt="" class="avatar avatar-sm me-3">
                                                <h4>{{ $course->subject_name }}</h4>
                                            </div>
                                        </td>
                                        <td><span class="text-primary font-w600"> {{ $course->grade }}</span></td>
                                        <td>
                                            <div class="date">{{ $course->created_at  }}</div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown custom-dropdown float-end">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('dashboard.course.remove',['id' => $course->id]) }}">Remove</a>
