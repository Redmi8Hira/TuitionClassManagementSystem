						...
						<div class="row">
                            ...
                            {{-- card start --}}
                                ...
                                <div class="row">
									...
									@foreach ($users as $user)  {{-- database eke variable eke data table ekata gannawa --}}
                                        ...
                                        <div class="card contact_list text-center">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
														...
														<div class="user-img">
															@if ($user->user_profile_photo !== null)
																<img src="{{ asset('user_profile_photos/' . $user->user_profile_photo) }}" alt="" class="avatar avatar-xl">
															@else
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
																...
																<a class="dropdown-item" href="{{ route('dashboard.user.remove',['id' => $user->id]) }}">Delete</a>
                                                ...
                                                <div class="contact-icon">
														...
														<span class="badge badge-success light">{{ $user->name }}</span>
												...
												<div class="d-flex align-items-center">
													@can('show_user_profile')
													 <a href="{{ route('dashboard.user.profile',['id' => $user->id]) }}" class="btn  btn-primary btn-sm w-50 me-2"><i class="fa-solid fa-user me-2"></i>Edit Profile</a>
													 @endcan
