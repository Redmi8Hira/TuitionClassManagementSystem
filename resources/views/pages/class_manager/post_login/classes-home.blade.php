                                        ...
                                        <div class="card contact_list text-center">
                                            <div class="card-body">
                                                <div class="user-content">
                                                    <div class="user-info">
                                                        <div class="user-img">
															{{-- @if ($teacher->teacher_profile_photo !== null)
																<img src="{{ asset('teacher_profile_photos/' . $teacher->teacher_profile_photo) }}" alt="" class="avatar avatar-xl">
															@else
																<img src="{{ asset('images/user.jpg') }}" class="avatar avatar-xl">
															@endif --}}
                                                        </div>
                                                        <div class="user-details">
                                                            {{-- <h4 class="user-name mb-0">{{ $class->$teacher_course->course->grade }} - {{ $class->$teacher_course->course->subject_name }} - {{ $class->$teacher_course->teacher->first_name }} Sir - {{ $class->$teacher_course->course->medium }} Medium</h4> --}}
                                                            {{-- <p>Teacher</p> --}}
                                                        </div>
                                                    </div>
													@can('delete_teacher')
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
																...
																{{-- <a class="dropdown-item" href="{{ route('dashboard.teacher.remove',['teacher_id' => $teacher->teacher_id]) }}">Delete</a> --}}
												...
												<div class="d-flex align-items-center">
													@can('show_teacher_profile')
														{{-- <a href="{{ route('dashboard.teacher.profile',['teacher_id' => $teacher->teacher_id]) }}" class="btn  btn-primary btn-sm w-50 me-2"><i class="fa-solid fa-user me-2"></i>Edit Profile</a> --}}
													@endcan
