    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0px 3px 10px rgba(0,0,0,0.1);">
        <tr>
            <td style="padding: 20px; background-color: #007BFF; color: #ffffff; border-radius: 10px 10px 0 0;">
                <h1 style="font-size: 28px; margin-bottom: 20px;">Welcome, Mr. {{ $teacher->first_name }}!</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px;">
                <p style="font-size: 16px; color: #333333;">You have successfully registered as a teacher.</p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f2f2f2; border: 1px solid #dddddd; border-radius: 5px; margin-top: 10px;">
                    <tr>
                        ...
                        <td style="padding: 10px; font-size: 16px; color: #333333;">{{ $teacher->email }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; font-size: 16px; color: #333333; font-weight: bold;">Password:</td>
                        <td style="padding: 10px; font-size: 16px; color: #333333;">{{ $teacher->password }}</td>
                    </tr>
                </table>
        ...
        <tr>
            <td style="padding: 20px; background-color: #007BFF; color: #ffffff; border-radius: 0 0 10px 10px;">
